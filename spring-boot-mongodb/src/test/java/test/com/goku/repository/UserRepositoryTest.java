...
public class UserRepositoryTest {
    ...
    public void test() throws Exception {
        ...
        this.logger.info("user total>>>>>>"+String.valueOf(userRepository.findAll().size()));
